    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-md mx-auto">
            ...
            <div className="relative">
                ...
                <button type="submit" className="absolute right-2.5 bottom-2.5 bg-[#2ce6e6]  focus:ring-4 focus:outline-none focus:ring-black font-medium rounded-lg text-sm px-4 py-2">Search</button>
            </div>
        </form>
    );
};
